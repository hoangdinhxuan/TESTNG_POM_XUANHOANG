...
//EMAIL
	...
	public void TC_04() {
		...
		verifyEqual(newCustormer.getDynamicText(data.NewCustomerPage().getFirstCharacterBlankSpaceMsg()),data.ExpectedMsgPage().getFirstCharacterBlankSpaceMsg());
	...
	public void TC_05() {
		...
		verifyEqual(newCustormer.getDynamicText(data.NewCustomerPage().getAddressCannotEmptyMsg()),data.ExpectedMsgPage().getAddressCannotEmptyMsg());
	}
...
//	1) Do not enter a value in CITY Field 2) Press TAB and move to next Field
	...
	public void TC_08() {
		...
		verifyEqual(newCustormer.getDynamicText(data.NewCustomerPage().getCityCannotEmptyMsg()),data.ExpectedMsgPage().getCityCannotEmptyMsg());
	}
...
//	9) Enter numeric value in CITY Field 1234 city123
	...
	public void TC_09() {
		...
		verifyEqual(newCustormer.getDynamicText(data.NewCustomerPage().getCannotBeNumbericMsg()),data.ExpectedMsgPage().getCannotBeNumbericMsg());
	}
...
//	10) Enter Special Character In CITY Field : City!@#
	...
	public void TC_10() {
		...
		verifyEqual(newCustormer.getDynamicText(data.NewCustomerPage().getCannotSpecialCharacterMsg()),data.ExpectedMsgPage().getCannotSpecialCharacterMsg());
	}
...
//12 Verify State Field State cannot be empt1) Do not enter a value in STATE Field 2) Press TAB and move to next Field.An error message "State must not be blank" must be shown
	...
	public void TC_12() {
		...
		verifyEqual(newCustormer.getDynamicText(data.NewCustomerPage().getStateCannotEmptyMsg()),data.ExpectedMsgPage().getStateCannotEmptyMsg());
	}
...
//16.1	 Verify PIN Field PIN must be numeric 1) Enter character value in PIN  Field//	1234 An error message "PIN Code must have 6 Digits " must be shown
	...
	public void TC_16_1() {
		...
		verifyEqual(newCustormer.getDynamicText(data.NewCustomerPage().getPinMustHave6DigitsMsg()),data.ExpectedMsgPage().getPinMustHave6DigitsMsg());
	}
...
//	16.2  input 1234PIN An error message "Characters are not allowed" must be shown
	...
	public void TC_16_2() {
		...
		verifyEqual(newCustormer.getDynamicText(data.NewCustomerPage().getMustBeNumbericMsg()),data.ExpectedMsgPage().getMustBeNumbericMsg());
	}
...
//	17 PIN cannot be empty//	1) Do not enter a value in PIN Field 2) Press TAB and move to next Field//	An error message "PIN code must not be blank" must be shown
	...
	public void TC_17() {
		...
		verifyEqual(newCustormer.getDynamicText(data.NewCustomerPage().getPinCannotEmptyMsg()),data.ExpectedMsgPage().getPinCannotEmptyMsg());
	}
...
//22	 Verify Telephone Field Telephone cannot be empty 1) Do not enter a value in Telephone Field 2) Press TAB and move to next Field//	 An error message "Mobile no must not be blank" must be shown
	...
	public void TC_21() {
		...
		verifyEqual(newCustormer.getDynamicText(data.NewCustomerPage().getMobileNumberCannotEmptyMsg()),data.ExpectedMsgPage().getMobileNumberCannotEmptyMsg());
	}
...
//	An error message "Email ID must not be blank" must be shown
	...
	public void TC_26() {
		...
		verifyEqual(newCustormer.getDynamicText(data.NewCustomerPage().getEmailCannotEmptyMsg()),data.ExpectedMsgPage().getEmailCannotEmptyMsg());
	}
...
//	30.Verify Field LabelsCheck all Fields name(Label) are as documented in SRS for all modules Cross check Field names with that in SRS Field names in SRS and system should match
	...
	public void TC_30() {
		...
		verifyEqual(newCustormer.getDynamicText(data.NewCustomerPage().getMessegerRegisteredSuccessfully()),data.ExpectedMsgPage().getMessegerRegisteredSuccessfully());
