...
//	30.Verify Field LabelsCheck all Fields name(Label) are as documented in SRS for all modules Cross check Field names with that in SRS Field names in SRS and system should match
	@Test
	public void TC_30() {
		newCustormer.inputNumberCustomerName("xuanhoang");
		newCustormer.inputDateOfBirth("12/10/1994");
		newCustormer.inputAddress("Tân Hiệp Hóc Môn");
		newCustormer.inputNumberCity("Ho Chi Minh");
		newCustormer.inputNumberState("Ho Chi Minh");
		...
		verifyEqual(newCustormer.getTexCustomerRegisteredSuccessfully(), "Customer Registered Successfully!!!");
